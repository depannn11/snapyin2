...
export function DouyinFeatures() {
  ...
  const features = [
    ...
    { icon: Download, title: t(tr.features.nowm_t,  lang), description: t(tr.features.nowm_d_dy, lang) },
    { icon: Globe,    title: t(tr.features.china_t, lang), description: t(tr.features.china_d,   lang) },
  ];
  return (
